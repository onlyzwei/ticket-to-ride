...
class Ticket:
    ...
    def pick_tickets(self, player, min_num_to_select=1):
        ...
        if tickets_to_deal <= 0:
            ...
            self._print_saida_tickets(player.get_tickets())
        ...
        self._print_saida_tickets(indexed_tickets)
    ...
    def _print_saida_tickets(self, tickets):
        print(Fore.CYAN + "------------------------------" + Style.RESET_ALL)
    
        for index, (origem, destino, valor) in tickets.items():
            print(Fore.WHITE + f"{index} - {origem} -> {destino}, {valor} pontos" + Style.RESET_ALL)
        print(Fore.CYAN + "------------------------------" + Style.RESET_ALL)
