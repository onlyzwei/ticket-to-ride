...
class Game(object):
    ...
    def _pick_cards(self, player):
        ...
        choice1 = input(f"{Fore.CYAN}Por favor digite uma carta da lista acima ou "
                        + f"digite '{Fore.WHITE}comprar{Fore.CYAN}' para comprar do monte: {Style.RESET_ALL}")
                                                
        while choice1 not in draw_pile + ['comprar'] and count < 5:
        ...
        while (choice2 == 'coringa' or choice2 not in draw_pile + ['comprar']) and count < 5:
